...
private:
	/// <summary>
	/// NastolÌ stupÚovÈ pravidlo od prvku smerom ku koreÚu
	/// </summary>
...
protected:
	...
	/// <summary>
	/// Vystrihne prvok a nasatavÌ stupÚovÈ pravidlo od priameho predka
	/// </summary>
	...
	/// <summary>
	/// Vystrihne potomkov prvku s vyööou prioritou a nastavÌ stupÚovÈ pravidlo od priameho predka poslednÈho vystrihnutÈho prvku
	/// </summary>
